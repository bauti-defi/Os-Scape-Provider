...
import org.osscape.api.definitions.ItemDefinition;
...
public class GroundItem implements Locatable, Identifiable, Nameable, Interactable {
	...
	public GroundItem(Object raw, Tile tile) {
		if (raw != null) {
			...
			location = tile;
			id = (int) Engine.getReflectionEngine().getFieldHookValue("ItemID", raw);
			amount = (int) Engine.getReflectionEngine().getFieldHookValue("StackSizes", raw);
